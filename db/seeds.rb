...
# Users
user = firm.users.create(full_name: "Mikael Eriksson",
                          user_name: "micke",
                          email: "micke@mail.com",
                          password: "password",
                          password_confirmation: "password")

antoher_user = firm.users.create(full_name: "Anders Cederberg",
                                user_name: "ac",
...
User.all.each do |user|
  ...
  number_of_clients.times do
    client = user.clients.create(last_name: Faker::Name.last_name,
    ...
    number_of_cases.times do
      client.legal_cases.create(name: Faker::Lorem.characters(10),
